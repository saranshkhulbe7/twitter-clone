...
const RegisterModal = () => {
  ...
  return (
    <Modal disabled={isLoading} isOpen={registerModal.isOpen} title="Create an account" actionLabel="Register" onClose={registerModal.onClose} onSubmit={onSumbit} body={bodyContent} footer={footerContent}/>
  )
}
